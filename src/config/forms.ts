...
export const formConfigs: FormConfig[] = [
  {
    ...
    talkTitle: "Towards Black Hole Movies in Radio Light",
    talkSpeaker:
      "Prashant Kocherlakota, Assistant Professor, Chennai Mathematical Institute",
    feeInfo: "Adults: ₹200\nKids under 12: Free",
    verifiedSuccess: {
      message:
        "Join the WhatsApp group using the link below. We will approve your WhatsApp group request within 2 hours of payment.",
      linkUrl: "https://chat.whatsapp.com/FFMD2Ol9gNkCC5gQjjyq45?mode=gi_t",
      linkLabel: "Join WhatsApp Group",
    },
    sheetTab: "September 27 Entries",
    paymentPricing: {
      adultFee: 200,
    ...
    fields: [
      ...
      },
      {
        ...
        helperText: "Maximum 2 adults (including you) and 2 children (below 12) per registration.",
        type: "radio",
        required: true,
        uiOnly: true,
        fullWidth: true,
      ...
      },
      {
        ...
        helperText:
          "Pay the amount above using the UPI ID or QR code (kids under 12 are free). After paying, enter the last 4 digits of the transaction ID from your UPI app.",
